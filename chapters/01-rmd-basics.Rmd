...
```{block type='savequote', quote_author='(ref:cicero-quote)', include=knitr::opts_knit$get('rmarkdown.pandoc.to') == 'latex'}
...
<!-- 
Three notes on chunk options for adding an opening quote in PDF output:
i) add the reference for the quote with quote_author="my author name",
