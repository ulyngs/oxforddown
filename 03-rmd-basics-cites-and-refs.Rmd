...
### Appearance of citations and references section (pandoc)
...
You can change the appearance of citations and references by specifying a CSL (Citation Style Language) file in the `csl` metadata field.
By default, it's set to the format used by the Americal Psychological Association (7th Edition), which is an author-year format.
