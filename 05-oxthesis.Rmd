...
# Notes on The OxThesis template and on collaboration
\minitoc <!-- this will include a mini table of contents-->

## Unnumbered chapters
To make chapters unnumbered (this is normally only relevant to the Introduction and/or the Conclusion), follow the chapter header with `{-}`, e.g. `# Introduction {-}`.
...
The correction highlighting is supplied by the [soul](https://ctan.org/pkg/soul) package, so you would do like this:
