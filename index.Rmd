...
mini-toc: false #mini-table of contents at start of each chapter?
mini-lot: false #mini-list of tables by start of each chapter?
mini-lof: false #mini-list of figures by start of each chapter?
draft: true
params:
  corrections: false # 'mccorrection' to apply blue background to corrections; otherwise false
...
mccorrect <- function(text) {
  text_spec(text, background = ifelse(params$corrections == 'mccorrection', "#CCCCFF", "#FFFFFF"))
}
```
