...
no-mini-toc: false  # no mini-table of contents at start of each chapter? (for them to show up, this must be calse, and you must also add \minitoc after the chapter titles)
no-mini-lot: true  # include mini-list of tables by start of each chapter?
no-mini-lof: true  # include mini-list of figures by start of each chapter?
