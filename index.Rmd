...
ordinary-page-number-position: C  #C = center, R = right, L = left. If page layour is 'twoside', O = odd pages and E = even pages. E.g. RO,LE puts the page number to the right on odd pages and left on even pages
...
draft-mark: false # add a DRAFT mark in the footer?
...
```{r ebook-welcome, child = 'front-and-back-matter/_00-welcome-ebook.Rmd', eval=knitr::is_html_output()}
```
