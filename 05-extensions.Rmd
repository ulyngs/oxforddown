...
## Including another paper in your thesis - embedding a PDF document {#embed-pdf}
...
## Including another paper in your thesis - include an R Markdown child document {#embed-rmd}
...
### 4. Make sure figure widths are correct
...
```{r, out.width=params$out_width, fig.cap="A very funny cat", eval=FALSE}
include_graphics(str_c(params$other_path, "figures/cat.jpg"))
```
