...
The following code, when it replaces the existing correpsonding code block in **templates/template.tex**, puts chapter number and title centered in the header and page number in the footer, centered. 
