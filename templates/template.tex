...
% UL the below sets where the page numbers are placed.
% If you want to always have the page number in the bottom center, then
% comment out the first three lines, and remove the comment on the fourth
\fancyhead[LO]{\emph{\leftmark}} 
\fancyhead[RE]{\emph{\rightmark}} 
\fancyhead[RO,LE]{\emph{\thepage}}
%\fancyfoot[C]{\emph{\thepage}}

% UL on pages with chapter titles, this places the page number center bottom on pages with chapter titles
