...
%UL add the option of setting section header spacing
\usepackage{titlesec}
% 
...
$endif$
\fancy$ordinary-page-number-foot-or-head$[$ordinary-page-number-position$]{\emph{\thepage}}

% UL page number position 
\fancypagestyle{plain}{\fancyhf{}\fancy$chapter-page-number-foot-or-head$[$chapter-page-number-position$]{\emph{\thepage}}}
