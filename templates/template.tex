...
\newenvironment{CSLReferences}[2] % #1 hanging-ident, #2 entry spacing
 {% don't indent paragraphs
  ...
  \fi
  % set entry spacing
  \setlength{\parskip}{$if(refs-space-between-entries)$$refs-space-between-entries$$else$1mm$endif$}
  \setlength{\baselineskip}{$if(refs-line-spacing)$$refs-line-spacing$$else$6mm$endif$}
 }%
 {}
\usepackage{calc}
