...
The potential problem with this tip when you write in R Markdown, though, is that you must then use \LaTeX\ rather than _R Markdown_ syntax inside of a `mccorrect` short correction.
...
Inside these, you can use _R Markdown_ syntax.
