...
<!-- Note the gotcha in the savequote block: if you want to note the author, you have to use LaTeX syntax directly with \qauthor{}, and when you do that, you must also use LaTeX formatting syntax if you want to, for example, italicise something -->
