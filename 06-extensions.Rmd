...
## Apply custom font color and highlighting to text
...
> Here's `[some text in green highlighting]{highlight="green"}` \
> Becomes: Here's [some text in green highlighting]{highlight="green"}.

> `[Here's some text with red font]{color="red"}` \
> Becomes: [Here's some text with red font]{color="red"}

> Finally --- never, ever actually do this -- `[here's some text with green highlighting and red font]{highlight="green" color="red"}` \
> Becomes: [here's some text with green highlighting and red font]{highlight="green" color="red"}
...
If you are a LaTeX expert and you need further customisation that what's currently provided, you can tweak the relevant sections of **templates/template.tex** - the relevant code is beneath the line that begins `\usepackage{fancyhdr}`.