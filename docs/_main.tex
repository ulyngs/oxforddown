...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (knitr}\SpecialCharTok{::}\NormalTok{opts\_knit}\SpecialCharTok{$}\FunctionTok{get}\NormalTok{(}\StringTok{\textquotesingle{}rmarkdown.pandoc.to\textquotesingle{}}\NormalTok{) }\SpecialCharTok{==} \StringTok{\textquotesingle{}latex\textquotesingle{}}\NormalTok{)\{}
...
\FunctionTok{\textbackslash{}def\textbackslash{}cleardoublepage}\NormalTok{\{}\FunctionTok{\textbackslash{}clearpage\textbackslash{}if@twoside} \FunctionTok{\textbackslash{}ifodd\textbackslash{}c@page\textbackslash{}else}
   \FunctionTok{\textbackslash{}hbox}\NormalTok{\{\}}
   \CommentTok{\% \textbackslash{}fancyhead[RE,LO]\{\}}
   \FunctionTok{\textbackslash{}fancyhead}\NormalTok{[CE,CO]\{\}}
   \FunctionTok{\textbackslash{}newpage}
   \FunctionTok{\textbackslash{}if@twocolumn\textbackslash{}hbox}\NormalTok{\{\}}\FunctionTok{\textbackslash{}newpage}
   ...
   \FunctionTok{\textbackslash{}fancyhead}\NormalTok{[CO]\{}\FunctionTok{\textbackslash{}emph}\NormalTok{\{}\FunctionTok{\textbackslash{}leftmark}\NormalTok{\}\} }
   \FunctionTok{\textbackslash{}fancyhead}\NormalTok{[CE]\{}\FunctionTok{\textbackslash{}emph}\NormalTok{\{}\FunctionTok{\textbackslash{}rightmark}\NormalTok{\}\} }
   \FunctionTok{\textbackslash{}fi\textbackslash{}fi}\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
