...
\hypertarget{make-sure-figure-widths-are-correct}{%
\subsection{4. Make sure figure widths are correct}\label{make-sure-figure-widths-are-correct}}
...
\begin{figure}
\includegraphics[width=1\linewidth]{../paper_to_include/figures/cat} \caption{A very funny cat}\label{fig:unnamed-chunk-16}
\end{figure}
...
\hypertarget{example-including-an-external-chapter}{%
\chapter{Example: Including an external chapter}\label{example-including-an-external-chapter}}
...
\begin{figure}
\includegraphics[width=1\linewidth]{../paper_to_include/figures/cat} \caption{A very funny cat}\label{fig:unnamed-chunk-24}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cat\_data }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(cat\_height, cat\_salt\_eating)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Cat height"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Daily amount of salt consumed"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-25}Cat height by cat salt eating}
\end{figure}
