...
\hypertarget{apply-custom-font-color-and-highlighting-to-text}{%
\section{Apply custom font color and highlighting to text}\label{apply-custom-font-color-and-highlighting-to-text}}
...
\begin{quote}
Finally --- never, ever actually do this -- \texttt{{[}here\textquotesingle{}s\ some\ text\ with\ white\ highlighting\ and\ yellow\ font{]}\{highlight="black"\ color="yellow"\}}\\
